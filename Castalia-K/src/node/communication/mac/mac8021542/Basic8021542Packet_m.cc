...
#include <iostream>
#include <sstream>
#include "Basic8021542Packet_m.h"
...
Basic8021542GTSspec::Basic8021542GTSspec()
{
    owner = 0;
    start = 0;
    length = 0;
...
class Basic8021542GTSspecDescriptor : public cClassDescriptor
{
  public:
    Basic8021542GTSspecDescriptor();
    virtual ~Basic8021542GTSspecDescriptor();
...
Register_ClassDescriptor(Basic8021542GTSspecDescriptor);

Basic8021542GTSspecDescriptor::Basic8021542GTSspecDescriptor() : cClassDescriptor("Basic8021542GTSspec", "")
{
}

Basic8021542GTSspecDescriptor::~Basic8021542GTSspecDescriptor()
{
}

bool Basic8021542GTSspecDescriptor::doesSupport(cObject *obj) const
{
    return dynamic_cast<Basic8021542GTSspec *>(obj)!=NULL;
}

const char *Basic8021542GTSspecDescriptor::getProperty(const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : NULL;
}

int Basic8021542GTSspecDescriptor::getFieldCount(void *object) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 3+basedesc->getFieldCount(object) : 3;
}

unsigned int Basic8021542GTSspecDescriptor::getFieldTypeFlags(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
...
const char *Basic8021542GTSspecDescriptor::getFieldName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int Basic8021542GTSspecDescriptor::findField(void *object, const char *fieldName) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
...
const char *Basic8021542GTSspecDescriptor::getFieldTypeString(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *Basic8021542GTSspecDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int Basic8021542GTSspecDescriptor::getArraySize(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    Basic8021542GTSspec *pp = (Basic8021542GTSspec *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

std::string Basic8021542GTSspecDescriptor::getFieldAsString(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
bool Basic8021542GTSspecDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *Basic8021542GTSspecDescriptor::getFieldStructName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
void *Basic8021542GTSspecDescriptor::getFieldStructPointer(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
Register_Class(Basic8021542Packet);

Basic8021542Packet::Basic8021542Packet(const char *name, int kind) : ::MacPacket(name,kind)
{
...
Basic8021542Packet::Basic8021542Packet(const Basic8021542Packet& other) : ::MacPacket(other)
{
    GTSlist_arraysize = 0;
    this->GTSlist_var = 0;
    copy(other);
...
Basic8021542Packet::~Basic8021542Packet()
{
    delete [] GTSlist_var;
}

Basic8021542Packet& Basic8021542Packet::operator=(const Basic8021542Packet& other)
{
...
void Basic8021542Packet::copy(const Basic8021542Packet& other)
{
    ...
    this->GTSlist_var = (other.GTSlist_arraysize==0) ? NULL : new Basic8021542GTSspec[other.GTSlist_arraysize];
...
void Basic8021542Packet::parsimPack(cCommBuffer *b)
{
...
void Basic8021542Packet::parsimUnpack(cCommBuffer *b)
{
    ...
    if (GTSlist_arraysize==0) {
        ...
        this->GTSlist_var = new Basic8021542GTSspec[GTSlist_arraysize];
        doUnpacking(b,this->GTSlist_var,GTSlist_arraysize);
    }
}

int Basic8021542Packet::getMac802154PacketType() const
{
    return Mac802154PacketType_var;
}

void Basic8021542Packet::setMac802154PacketType(int Mac802154PacketType)
{
    this->Mac802154PacketType_var = Mac802154PacketType;
}

int Basic8021542Packet::getPANid() const
{
    return PANid_var;
}

void Basic8021542Packet::setPANid(int PANid)
{
    this->PANid_var = PANid;
}

int Basic8021542Packet::getSrcID() const
{
    return srcID_var;
}

void Basic8021542Packet::setSrcID(int srcID)
{
    this->srcID_var = srcID;
}

int Basic8021542Packet::getDstID() const
{
    return dstID_var;
}

void Basic8021542Packet::setDstID(int dstID)
{
    this->dstID_var = dstID;
}

int Basic8021542Packet::getSeqNum() const
{
    return seqNum_var;
}

void Basic8021542Packet::setSeqNum(int seqNum)
{
    this->seqNum_var = seqNum;
}

int Basic8021542Packet::getBeaconOrder() const
{
    return beaconOrder_var;
}

void Basic8021542Packet::setBeaconOrder(int beaconOrder)
{
    this->beaconOrder_var = beaconOrder;
}

int Basic8021542Packet::getFrameOrder() const
{
    return frameOrder_var;
}

void Basic8021542Packet::setFrameOrder(int frameOrder)
{
    this->frameOrder_var = frameOrder;
}

int Basic8021542Packet::getBSN() const
{
    return BSN_var;
}

void Basic8021542Packet::setBSN(int BSN)
{
    this->BSN_var = BSN;
}

int Basic8021542Packet::getCAPlength() const
{
    return CAPlength_var;
}

void Basic8021542Packet::setCAPlength(int CAPlength)
{
    this->CAPlength_var = CAPlength;
}

int Basic8021542Packet::getGTSlength() const
{
    return GTSlength_var;
}

void Basic8021542Packet::setGTSlength(int GTSlength)
{
    this->GTSlength_var = GTSlength;
}

void Basic8021542Packet::setGTSlistArraySize(unsigned int size)
{
    Basic8021542GTSspec *GTSlist_var2 = (size==0) ? NULL : new Basic8021542GTSspec[size];
...
unsigned int Basic8021542Packet::getGTSlistArraySize() const
{
    return GTSlist_arraysize;
}

Basic8021542GTSspec& Basic8021542Packet::getGTSlist(unsigned int k)
{
    if (k>=GTSlist_arraysize) throw cRuntimeError("Array of size %d indexed by %d", GTSlist_arraysize, k);
    return GTSlist_var[k];
}

void Basic8021542Packet::setGTSlist(unsigned int k, const Basic8021542GTSspec& GTSlist)
{
    if (k>=GTSlist_arraysize) throw cRuntimeError("Array of size %d indexed by %d", GTSlist_arraysize, k);
    this->GTSlist_var[k] = GTSlist;
}

class Basic8021542PacketDescriptor : public cClassDescriptor
{
  public:
    Basic8021542PacketDescriptor();
    virtual ~Basic8021542PacketDescriptor();
...
Register_ClassDescriptor(Basic8021542PacketDescriptor);

Basic8021542PacketDescriptor::Basic8021542PacketDescriptor() : cClassDescriptor("Basic8021542Packet", "MacPacket")
{
}

Basic8021542PacketDescriptor::~Basic8021542PacketDescriptor()
{
}

bool Basic8021542PacketDescriptor::doesSupport(cObject *obj) const
{
    return dynamic_cast<Basic8021542Packet *>(obj)!=NULL;
}

const char *Basic8021542PacketDescriptor::getProperty(const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : NULL;
}

int Basic8021542PacketDescriptor::getFieldCount(void *object) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 11+basedesc->getFieldCount(object) : 11;
}

unsigned int Basic8021542PacketDescriptor::getFieldTypeFlags(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *Basic8021542PacketDescriptor::getFieldName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int Basic8021542PacketDescriptor::findField(void *object, const char *fieldName) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    int base = basedesc ? basedesc->getFieldCount(object) : 0;
...
const char *Basic8021542PacketDescriptor::getFieldTypeString(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *Basic8021542PacketDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int Basic8021542PacketDescriptor::getArraySize(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    Basic8021542Packet *pp = (Basic8021542Packet *)object; (void)pp;
    switch (field) {
...
std::string Basic8021542PacketDescriptor::getFieldAsString(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
bool Basic8021542PacketDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *Basic8021542PacketDescriptor::getFieldStructName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    switch (field) {
        case 10: return opp_typename(typeid(Basic8021542GTSspec));
        default: return NULL;
    };
}

void *Basic8021542PacketDescriptor::getFieldStructPointer(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
