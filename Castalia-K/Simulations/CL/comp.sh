...
Castalia -c ZigBeeMAC,General,setRate,setInterferenceModel,varyPowerRange,[setPolicyVaryPowerInCycle,setPolicyVaryPowerBetweenRange] -r 33 -o saida.txt

CastaliaResults -i saida.txt -s packets -n -o2 --all > packets.txt
