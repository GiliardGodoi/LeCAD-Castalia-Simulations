...
Castalia -c General,ZigBeeMAC,setRate,varyInterferenceModel,traceFromMac -r 1 -o saida.txt
...
CastaliaResults -i saida.txt -s "TaxaMAC evaluation" -n --all -o2 > taxamac_evaluation.txt
