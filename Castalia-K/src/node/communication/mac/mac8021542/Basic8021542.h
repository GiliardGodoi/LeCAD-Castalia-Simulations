...
class Basic8021542: public VirtualMac {
 private:
	...
	Basic8021542Packet *beaconPacket;
	Basic8021542Packet *currentPacket;
	...
	void handleAckPacket(Basic8021542Packet *);
	void performCSMACA();
  ...
  protected:
	...
	Basic8021542Packet *newConnectionRequest(int);
	Basic8021542Packet *newGtsRequest(int,int);
	Basic8021542Packet *getCurrentPacket() { return currentPacket; }
	void transmitPacket(Basic8021542Packet *pkt, int retries = 0, bool GTSonly = false, double delay = 0);
	...
	virtual void dataReceived_hub(Basic8021542Packet *) {}
	virtual int gtsRequest_hub(Basic8021542Packet *) { return 0; }			//default: always reject
	virtual int associationRequest_hub(Basic8021542Packet *) { return 1; }	//default: always accept
	virtual void prepareBeacon_hub(Basic8021542Packet *) {}
	...
	virtual void receiveBeacon_node(Basic8021542Packet *);
	virtual void startedGTS_node() {}

	/*--- General desicions ---*/
	virtual bool acceptNewPacket(Basic8021542Packet *);
	virtual void transmissionOutcome(Basic8021542Packet *, bool, string);
};
