...
Castalia -c General,ZigBeeMAC,setRate,varyInterferenceModel,traceFromApp,traceFromMac -r 100 -o saida.txt
...
awk -f janelaMACInter.awk Castalia-Trace.txt > taxaMAC.csv
...
echo "FIM DA SIMULAÇÃO CL Policy"
